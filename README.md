...
- Queue multiple generations while continuing to edit the controls. Each click freezes its prompt, model, quality, references, Photoshop pixels, selection and destination. Up to five provider requests run concurrently in the internal build; additional jobs wait.
